...
## Project Structure
    ...
    ├── testapiautosetting_125093  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125093`
...
2. Clone this repo and `cd testapiautosetting_125093`
